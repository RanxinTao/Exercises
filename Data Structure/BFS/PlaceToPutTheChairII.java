...
/**
 * Given a gym with k pieces of equipment without any obstacles. Let¡¯s say we bought a chair and wanted to put this chair 
 * into the gym such that the sum of the shortest path cost from the chair to the k pieces of equipment is minimal. The gym 
 * is represented by a char matrix, ¡®E¡¯ denotes a cell with equipment, ' ' denotes a cell without equipment. 
